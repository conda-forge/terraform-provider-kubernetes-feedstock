...
validate_recipe_outputs "terraform-provider-kubernetes-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="terraform-provider-kubernetes-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi